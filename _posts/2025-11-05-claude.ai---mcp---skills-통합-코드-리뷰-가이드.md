...
date: 2025-11-05 20:00:00 +0900
categories: [AI,  Claude]
mermaid: [True]
tags: [AI,  Claude.ai,  MCP,  agent-skills,  claude-skills,  Claude.write]
---
...
1. [개요: 세 가지 도구의 시너지](#개요-세-가지-도구의-시너지)
2. [기술 스택 이해하기](#기술-스택-이해하기)
3. [통합 아키텍처](#통합-아키텍처)
4. [단계별 구축 가이드](#단계별-구축-가이드)
5. [실전 시나리오](#실전-시나리오)
6. [고급 패턴](#고급-패턴)
7. [보안 및 거버넌스](#보안-및-거버넌스)
8. [트러블슈팅](#트러블슈팅)
...
각각의 도구는 고유한 강점이 있지만, **함께 사용할 때 진정한 힘**이 발휘됩니다:
...
**특징**:
MCP는 2024년 11월 Anthropic이 도입한 개방형 표준으로, AI 시스템이 외부 데이터 소스와 통합하는 방식을 표준화합니다
