...
flowchart TB
    ...
    subgraph BULL["📈 강세 연구팀 (Bullish)"]
        ...
        BR["Apple Investment Outlook\n✅ Growth Potential: AI 기반 스마트홈 확장\n✅ Strong Financials: 탄탄한 현금흐름\n✅ Market Sentiment: 기관 투자자 긍정 전망"]
        BG --> BR
    end

    subgraph BEAR["📉 약세 연구팀 (Bearish)"]
        BEG["목표: Apple Inc. 투자 리스크 평가"]
        BER["Apple Investment Risks\n⚠️ Competitive Challenges: 스마트홈 후발 진입\n⚠️ Geopolitical Tensions: 미중 갈등 리스크\n⚠️ Valuation & Liquidity: 고평가 + 유동성 리스크"]
        BEG --> BER
    end

    DEBATE["🔄 Debate - 양방향 반박·보완"]
