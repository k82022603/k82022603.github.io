---
title: "AI 코딩 도구 통합 개발자 매뉴얼"
date: 2026-01-04 08:00:00 +0900
categories: [AI,  Vibe Coding]
mermaid: [True]
tags: [AI,  GitHub,  Codex,  claude-code,  Antigravity,  vibe-coding,  coding-agents,  Developer,  Claude.write]
---
...
**파일 생성**: `~/.claude/commands/devlog.md`
...
**파일 생성**: `~/.claude/commands/hello.md`
```bash
---
description: "인사"
---
...
**파일 생성**: `~/.claude/commands/deploy.md`
...
**3. AI 통합 커맨드 (최고급)**
**파일 생성**: `~/.claude/commands/refactor.md`
...
**매일 퇴근 전(End Of Day) 루틴:**

**파일 생성**: `~/.claude/commands/eod.md`
