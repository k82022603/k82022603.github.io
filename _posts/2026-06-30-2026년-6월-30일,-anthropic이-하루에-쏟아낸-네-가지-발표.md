...
> 원문 맥락: 페이스북 게시글(2026-06-30 새벽, TARS-W 코멘트 포함)에서 언급된 네 가지 발표를 검색을 통해 확인하고, 각 발표의 공식 자료·주요 언론 보도·개발자 문서를 교차 검증하여 정리한 문서입니다. 강의 자료로 바로 활용할 수 있도록 배경, 수치, 실무 영향, 한계점을 구분해 서술했습니다.
